...
def process_pyx(fromfile, tofile):
    ...
    try:
        try:
            ...
            # print('fromfile: {}'.format(fromfile))
...
rules = {'.pyx': process_pyx, '.pyx.in': process_tempita_pyx}
...
def find_process_files(root_dir):
    ...
    # cppflag_regex = br"^\s*#\s*distutils:\s*language\s*=\s*c\+\+\s*$"
            ...
            for fromext, function in rules.items():
                if filename.endswith(fromext):
                    ...
                    with open(os.path.join(cur_dir, filename), 'rb') as f:
                        ...
                        # m = re.search(cppflag_regex, data, re.I | re.M)

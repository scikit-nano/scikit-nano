...
class Tests(GeneratorTestFixture):
    ...
    def test1(self):
        mwnt = MWNTGenerator(max_walls=2, L=10.0)
    ...
    def test2(self):
        mwnt = MWNTGenerator(Ch=[(5, 5), (10, 10)], L=10.0)
    ...
    def test3(self):
        mwnt = MWNTGenerator(Ch=[(3, 3), (5, 5), (10, 10)], L=10.0)
    ...
    def test4(self):
        bundle = MWNTGenerator(max_walls=2, L=10.0, bundle_geometry='hexagon')
        bundle.save()
    ...
    def test5(self):
        Ch = [(5, 5), (6, 6), (7, 7), (8, 8)]
        bundle = MWNTGenerator(Ch=Ch, L=5.0, bundle_geometry='hexagon')
        bundle.save()
        self.tmpdata.append(bundle.fname)
        bundle.save(structure_format='data')
        self.tmpdata.append(bundle.fname)
    ...
    def test6(self):
        Ch = [(3, 3), (4, 4), (5, 5)]
        bundle = MWNTGenerator(Ch=Ch, n1=5, n2=2, L=5.0)
        print(set(bundle.atoms.mols))
        assert_equal(len(set(bundle.atoms.mols)), bundle.n1 * bundle.n2)
        bundle.save()
        self.tmpdata.append(bundle.fname)
        bundle.save(structure_format='data')
        self.tmpdata.append(bundle.fname)
    ...
    def test7(self):
        Ch_list = [(3, 3), (4, 4), (5, 5)]
        mwnt = MWNTGenerator(Ch_list=Ch_list, L=10.0)
        ...
        bundle = MWNTGenerator(Ch_list=Ch_list, n1=3, n2=2, L=10.0)
    ...
    def test8(self):
        Ch_list = [(5, 0), (10, 0)]
        mwnt = MWNTGenerator(Ch_list=Ch_list, n3=5, verbose=False)
        mwnt.save()
        self.tmpdata.append(mwnt.fname)

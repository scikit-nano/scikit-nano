...
__all__ = ['POAV', 'POAV1', 'POAV2', 'POAVR', 'POAVAtom']
...
class POAVAtom(KDTAtom):
    ...
    """
    _atomattrs = KDTAtom._atomattrs + ['POAVlist', 'POAV1', 'POAV2', 'POAVR']

...
"""
=======================================================================
NanoGen model views (:mod:`sknano.apps.nanogen_gui.nanogen_views`)
=======================================================================

.. currentmodule:: sknano.apps.nanogen_gui.nanogen_views
...
class NanoGenView(QMainWindow, Ui_NanoGen):
    ...
    def on_swnt_generator_push_button_clicked(self):
        from .nanogen_controllers import SWNTGeneratorController
        from .nanogen_models import SWNTModel
    ...
    def on_graphene_generator_push_button_clicked(self):
        from .nanogen_controllers import GrapheneGeneratorController
        from .nanogen_models import GrapheneModel
        self.generator_controller = \
    ...
    def on_fullerene_generator_push_button_clicked(self):
        from .nanogen_controllers import FullereneGeneratorController
        from .nanogen_models import FullereneModel
        self.generator_controller = \

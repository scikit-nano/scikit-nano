...
class Ui_SWNTGenerator(object):
    def setupUi(self, SWNTGenerator):
        ...
        self.swnt_n3_double_spin_box = QtWidgets.QDoubleSpinBox(self.centralwidget)
        self.swnt_n3_double_spin_box.setMinimumSize(QtCore.QSize(100, 36))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(16)
        self.swnt_n3_double_spin_box.setFont(font)
        self.swnt_n3_double_spin_box.setDecimals(2)
        self.swnt_n3_double_spin_box.setMaximum(1000.0)
        self.swnt_n3_double_spin_box.setProperty("value", 1.0)
        self.swnt_n3_double_spin_box.setObjectName("swnt_n3_double_spin_box")
        self.horizontalLayout_6.addWidget(self.swnt_n3_double_spin_box)
        ...
        self.swnt_L_double_spin_box = QtWidgets.QDoubleSpinBox(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.swnt_L_double_spin_box.sizePolicy().hasHeightForWidth())
        self.swnt_L_double_spin_box.setSizePolicy(sizePolicy)
        self.swnt_L_double_spin_box.setMinimumSize(QtCore.QSize(200, 36))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(16)
        self.swnt_L_double_spin_box.setFont(font)
        self.swnt_L_double_spin_box.setReadOnly(True)
        self.swnt_L_double_spin_box.setDecimals(4)
        self.swnt_L_double_spin_box.setMaximum(1000.0)
        self.swnt_L_double_spin_box.setObjectName("swnt_L_double_spin_box")
        self.horizontalLayout_9.addWidget(self.swnt_L_double_spin_box)
        self.horizontalLayout_23.addLayout(self.horizontalLayout_9)
        self.swnt_fix_L_check_box = QtWidgets.QCheckBox(self.centralwidget)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(16)
        self.swnt_fix_L_check_box.setFont(font)
        self.swnt_fix_L_check_box.setCheckable(True)
        self.swnt_fix_L_check_box.setObjectName("swnt_fix_L_check_box")
        self.horizontalLayout_23.addWidget(self.swnt_fix_L_check_box)
        ...
        self.verticalLayout.addWidget(self.bundle_generator_check_box)
        ...
        self.bundle_n1_spin_box.setMinimumSize(QtCore.QSize(100, 36))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(16)
        ...
        self.horizontalLayout_4.addWidget(self.bundle_n1_spin_box)
        ...
        self.bundle_n2_spin_box.setMinimumSize(QtCore.QSize(100, 36))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(16)
        ...
        self.horizontalLayout_5.addWidget(self.bundle_n2_spin_box)
        self.horizontalLayout_7.addLayout(self.horizontalLayout_5)
        spacerItem3 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_7.addItem(spacerItem3)
        self.verticalLayout.addLayout(self.horizontalLayout_7)
        self.horizontalLayout_8.addLayout(self.verticalLayout)
        spacerItem4 = QtWidgets.QSpacerItem(17, 35, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
    ...
    def retranslateUi(self, SWNTGenerator):
        ...
        self.label_4.setText(_translate("SWNTGenerator", "<html><head/><body><p><span style=\" font-style:italic;\">n</span><span style=\" vertical-align:sub;\">3 </span>=</p></body></html>"))
        self.label_13.setText(_translate("SWNTGenerator", "<html><head/><body><p><span style=\" font-style:italic;\">L</span><span style=\" vertical-align:sub;\"/>= </p></body></html>"))
        self.swnt_L_double_spin_box.setSuffix(_translate("SWNTGenerator", " Å"))
        self.swnt_fix_L_check_box.setText(_translate("SWNTGenerator", "Fix L"))
        self.bundle_generator_check_box.setText(_translate("SWNTGenerator", "Bundle Generator"))
        self.label.setText(_translate("SWNTGenerator", "<html><head/><body><p><span style=\" font-style:italic;\">n</span><span style=\" vertical-align:sub;\">1 </span>=</p></body></html>"))
        self.label_3.setText(_translate("SWNTGenerator", "<html><head/><body><p><span style=\" font-style:italic;\">n</span><span style=\" vertical-align:sub;\">2 </span>=</p></body></html>"))

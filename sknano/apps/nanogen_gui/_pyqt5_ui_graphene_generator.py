...
class Ui_GrapheneGenerator(object):
    def setupUi(self, GrapheneGenerator):
        ...
        self.unrolled_swnt_n1_spin_box = QtWidgets.QSpinBox(self.centralwidget)
        ...
        self.unrolled_swnt_n1_spin_box.setObjectName("unrolled_swnt_n1_spin_box")
        ...
        self.unrolled_swnt_n3_spin_box = QtWidgets.QSpinBox(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.unrolled_swnt_n3_spin_box.setObjectName("unrolled_swnt_n3_spin_box")
    ...
    def retranslateUi(self, GrapheneGenerator):
        ...
        self.armchair_edge_length_double_spin_box.setSuffix(_translate("GrapheneGenerator", " Å"))
        ...
        self.zigzag_edge_length_double_spin_box.setSuffix(_translate("GrapheneGenerator", " Å"))
        ...
        self.edge_length_double_spin_box.setSuffix(_translate("GrapheneGenerator", " Å"))
        ...
        self.label_31.setText(_translate("GrapheneGenerator", "<html><head/><body><p><span style=\" font-style:italic;\">n</span><span style=\" vertical-align:sub;\">1 </span>=</p></body></html>"))
        self.label_29.setText(_translate("GrapheneGenerator", "<html><head/><body><p><span style=\" font-style:italic;\">n</span><span style=\" vertical-align:sub;\">3 </span>=</p></body></html>"))

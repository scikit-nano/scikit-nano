...
class Ui_MWNTGenerator(object):
    def setupUi(self, MWNTGenerator):
        ...
        MWNTGenerator.setMinimumSize(QtCore.QSize(600, 600))
    ...
    def retranslateUi(self, MWNTGenerator):
        ...
        item.setText(_translate("MWNTGenerator", "(5, 5)"))
        item = self.mwnt_Ch_list_widget.item(1)
        item.setText(_translate("MWNTGenerator", "(10,10)"))
        item = self.mwnt_Ch_list_widget.item(2)
        item.setText(_translate("MWNTGenerator", "(20, 20)"))

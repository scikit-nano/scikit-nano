...
class Ui_MWNTGenerator(object):
    def setupUi(self, MWNTGenerator):
        ...
        self.mwnt_L_double_spin_box = QtGui.QDoubleSpinBox(self.centralwidget)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.mwnt_L_double_spin_box.setObjectName(_fromUtf8("mwnt_L_double_spin_box"))
    ...
    def retranslateUi(self, MWNTGenerator):
        ...
        self.label_20.setText(_translate("MWNTGenerator", "<html><head/><body><p><span style=\" font-style:italic;\">L</span><span style=\" vertical-align:sub;\"/>= </p></body></html>", None))
        self.mwnt_L_double_spin_box.setSuffix(_translate("MWNTGenerator", " Å", None))
        self.bundle_generator_check_box.setText(_translate("MWNTGenerator", "Bundle Generator", None))
        self.label_8.setText(_translate("MWNTGenerator", "<html><head/><body><p><span style=\" font-style:italic;\">n</span><span style=\" vertical-align:sub;\">1 </span>=</p></body></html>", None))
        self.label_21.setText(_translate("MWNTGenerator", "<html><head/><body><p><span style=\" font-style:italic;\">n</span><span style=\" vertical-align:sub;\">2 </span>=</p></body></html>", None))

...
def process_tex(lines):
    ...
    for line in lines:
        ...
        if (line.startswith(r'\section{sknano.')
            or line.startswith(r'\subsection{sknano.')
            or line.startswith(r'\subsubsection{sknano.')
            or line.startswith(r'\paragraph{sknano.')
            or line.startswith(r'\subparagraph{sknano.')
            ):
            pass # skip!
        else:
